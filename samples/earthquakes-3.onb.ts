...
import { md, DOM, Generators } from "@observablehq/stdlib";
...
//%%
module.variable(observer("viewof rotation")).define(() => {
...
module
  ...
  .define(["viewof rotation"], (rotation: HTMLInputElement) =>
    Generators.input(rotation)
  );

//%%
module.variable(observer("viewof quakeSize")).define(DOM.range(0, 12));
module
  .variable()
...
//%%
module.variable(observer("viewof quakeColor")).define(() => {
...
//%%
module.variable(observer("quakes")).define(async () => {
...
module
  ...
  .define(["quakes"], (quakes: Quakes) => quakes.features[30].properties);

//%%
module.variable(observer("world")).define(async () => {
